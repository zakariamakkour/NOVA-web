...
const JournalDetail: React.FC<JournalDetailProps> = ({ article, language, onBack }) => {
       ...
       <div className="max-w-3xl mx-auto px-6 md:px-12 -mt-32 relative z-10 pb-32">
          <div className="bg-[#F5F2EB] p-8 md:p-16 shadow-xl shadow-[#2C2A26]/5">
             <div className="flex justify-between items-center mb-12 border-b border-[#D6D1C7] pb-8">
                <button 
                  onClick={onBack}
                  className="group flex items-center gap-2 text-xs font-medium uppercase tracking-widest text-[#A8A29E] hover:text-[#2C2A26] transition-colors rtl:flex-row-reverse"
                >
             ...
             <div className="mt-16 pt-12 border-t border-[#D6D1C7] flex justify-center">
                 <span className="text-2xl font-serif italic text-[#2C2A26]">Nova</span>
             </div>
          </div>
       </div>
    </div>
